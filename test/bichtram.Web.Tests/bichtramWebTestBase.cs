...
{
    public abstract class bichtramWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static bichtramWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(bichtramWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<bichtramDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<bichtramDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<bichtramDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<bichtramDbContext, Task<T>> func)
        {
            T result;
